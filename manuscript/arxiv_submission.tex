...
\begin{abstract}
\noindent We report empirical evidence for a scaling exponent $\gamma \approx 1.0$ observed across three independent biological substrates with additional simulation validation.
