...
def auto_heal(
    ...
    if not needs_healing:
        ...
        return _early_heal_result(
            severity_before, det_before, hwi_before, elapsed, needs_healing=False
        )
    ...
    if best is None or not plan.has_viable_plan:
        elapsed = (time.perf_counter() - t0) * 1000
        return _early_heal_result(
            severity_before, det_before, hwi_before, elapsed, needs_healing=True
        )
