...
class ObservatoryReport:
    ...
    def __str__(self) -> str:
        ...
        lines = [
            ...
            "╠" + "═" * w + "╣",
            f"║  Grid: {self.grid_size}×{self.grid_size}  Steps: {self.n_steps}  Seed: {self.seed}".ljust(
                w + 1
            )
            + "║",
            "╠" + "─" * w + "╣",
            ...
            f"║    Entropy prod σ    = {self.entropy_production:.6f} ({self.entropy_regime})".ljust(
                w + 1
            )
            + "║",
            ...
            + "║",
            f"║    D_box={self.d_box:.3f}  H_topo={self.topological_entropy:.3f}  class={self.complexity_class}".ljust(
                w + 1
            )
            + "║",
            "╠" + "─" * w + "╣",
            ...
            + "║",
            f"║    Anisotropy={self.anisotropy:.3f}  Coherence={self.coherence:.3f}  Defects={self.defect_count}".ljust(
                w + 1
            )
            + "║",
            "╠" + "─" * w + "╣",
            ...
            f"║    Criticality={self.criticality_score:.3f} ({self.criticality_verdict})  ξ={self.correlation_length:.1f}".ljust(
                w + 1
            )
            + "║",
            "╠" + "─" * w + "╣",
            ...
            + "║",
            f"║    EWS: {self.ews_score:.3f}  Attractors: {self.n_attractors}  Roughness: {self.landscape_roughness:.4f}".ljust(
                w + 1
            )
            + "║",
            "╠" + "─" * w + "╣",
            f"║  Lenses: {self.n_lenses_computed}/8 computed in {self.compute_time_ms:.0f}ms".ljust(
                w + 1
            )
            + "║",
        ]
