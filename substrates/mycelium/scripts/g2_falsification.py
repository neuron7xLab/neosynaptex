...
def run() -> dict:
    ...
    print(
        f"  pure_noise:    D_f={ccp_noise['D_f']:.4f} R={ccp_noise['R']:.4f} cognitive={ccp_noise['cognitive']} {'CORRECT' if not ccp_noise['cognitive'] else 'WRONG'}"
    )
    ...
    print(
        f"  flat_field:    D_f={ccp_flat['D_f']:.4f} R={ccp_flat['R']:.4f} cognitive={ccp_flat['cognitive']} {'CORRECT' if not ccp_flat['cognitive'] else 'WRONG'}"
    )
    ...
    print(
        f"  checkerboard:  D_f={ccp_checker['D_f']:.4f} R={ccp_checker['R']:.4f} cognitive={ccp_checker['cognitive']}"
    )
    ...
    print(
        f"  healthy_mfn:   D_f={ccp_healthy['D_f']:.4f} R={ccp_healthy['R']:.4f} cognitive={ccp_healthy['cognitive']} {'CORRECT' if ccp_healthy['cognitive'] else 'WRONG'}"
    )
    ...
    print(
        f"  extreme_spike: D_f={ccp_spike['D_f']:.4f} R={ccp_spike['R']:.4f} cognitive={ccp_spike['cognitive']}"
    )
