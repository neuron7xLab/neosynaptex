...
class TestInvariantIV:
    def test_ssi_internal_raises_invariant_violation(self):
        from contracts.invariants import ssi_apply, SSIDomain, InvariantViolation
    ...
    def test_ssi_external_valid(self):
        from contracts.invariants import ssi_apply, SSIDomain
    ...
    def test_invariant_i_gamma_derived(self):
        from contracts.invariants import enforce_gamma_derived, InvariantViolation
    ...
    def test_invariant_ii_state_not_proof(self):
        from contracts.invariants import enforce_state_not_proof, InvariantViolation
...
class TestAxiom0:
    def test_axiom_consistency_valid(self):
        from axioms import verify_axiom_consistency
        state = {
            "gamma": 0.994,
    ...
    def test_axiom_fails_no_gamma(self):
        from axioms import verify_axiom_consistency
        assert verify_axiom_consistency({"substrates": ["a", "b"], "convergence_slope": -0.001}) is False
    ...
    def test_substrate_gamma_values(self):
        from axioms import SUBSTRATE_GAMMA
