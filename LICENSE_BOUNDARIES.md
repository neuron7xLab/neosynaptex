...
| TradePulse/Kuramoto | `substrates/kuramoto/` | TBD / Proprietary or AGPL (must be fixed) | No redistribution assumptions until license decision |
...
- Kuramoto final license posture: **UNKNOWN**.
